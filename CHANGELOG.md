...
### Fixed
- **Firefox Compatibility**: Removed invalid `"windows"` permission from manifest to resolve warning during loading.

## [3.2.1] - 2026-07-26

### Fixed
- **Extension Icon**: Reverted extension icon to previous working design to fix Chrome rendering issue.
